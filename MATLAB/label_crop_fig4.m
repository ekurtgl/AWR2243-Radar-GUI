...
impath = ['C:\Users\emrek\Desktop\Technical\77ghz\spects\' sub '\'];
...
%     while flag
    for j = 1:length(seq)
        ...
        if j == 1
            m = 350;
            h = imrect(gca,[15 52 m n]);
        elseif j == 2
            h = imrect(gca,[380 52 m n]);
        elseif j == 3
            h = imrect(gca,[580 52 m n]);
        elseif j == 4
            h = imrect(gca,[830 52 m n]);
        elseif j == 5
            h = imrect(gca,[1080 52 m n]);
        elseif j == 6
            h = imrect(gca,[1330 52 m n]);
        end
